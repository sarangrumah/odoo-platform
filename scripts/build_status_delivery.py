...
EO = [
    (
        "1",
        "Migrasi saldo TB tidak disertai detail AR/AP per partner",
        CLIENT,
    ...
    (
        "2",
        "Transaksi valuta asing belum bisa — kurs belum di-set",
        CLIENT,
    ...
    (
        "3",
        "Kartu utang & piutang belum terintegrasi dengan data input",
        DONE,
        ...
        "ARKA: 9 baris kosong -> 34 baris terisi. Levi's: 378 / 4.989 baris",
        "cea129b",
    ),
    (
        "4",
    ...
    (
        "5",
        "Purchase report keluar Trial Balance",
        DONE,
        "Report code tidak terdaftar di dispatcher sehingga jatuh ke fallback Trial Balance",
        "prd_levis_begbal 69 baris; prd_arkaaim 9 baris",
        "5a405ab",
    ),
    (
        "6",
        "Jurnal DP masuk ke COA penjualan",
        DONE,
        "downpayment_account_id diarahkan ke 2108100001 Advances from customers",
        "Diterapkan pada 2 company; re-run script melaporkan OK / 0 changes",
        "8db557e",
    ),
    (
        "7",
        "Akses closing period belum tersedia",
        CLIENT,
    ...
    (
        "8",
        "Nilai perolehan asset selisih vs report accounting",
        HOLD,
    ...
    (
        "9",
        "No document depresiasi per bulan belum muncul",
        HOLD,
        ...
        "bergerak persis sebesar itu; reverse 1 baris tidak mengubah jurnal bulanan",
        "d1c8952",
    ),
    (
        "10",
        "Sales report kosong padahal ada di detail beginning balance",
        DONE,
        ...
        "Basis GL 735.585.585 = revenue GL independen (selisih 0,00); basis dokumen hanya 150.000.000",
        "cea129b",
    ),
    (
        "11",
        "PPh withholding belum otomatis per kode objek",
        DONE,
    ...
    (
        "12",
        "Setting due date belum sesuai ketentuan Erajaya",
        CLIENT,
    ...
    (
        "13",
        "Alamat AIM belum lengkap di Bill / Jurnal Voucher",
        CLIENT,
    ...
    (
        "14",
        "Tambah nomor seri faktur pajak saat tarik GL",
        DONE,
        "2 kolom opsional (No. FP Masukan / Keluaran), default OFF karena modul dipakai semua tenant",
        "408 baris ber-NSFP di prd_levis_begbal; 17 di prd_arkaaim",
        "849fadc",
    ),
    (
        "15",
        "Generate format impor PSIAP faktur keluaran",
        CLIENT,
...
FASHION = [
    (
        "1.1",
        "Rekap PPh + Kode Objek, COA Expense, No/Tgl Invoice, No Dok Jurnal",
        DONE,
    ...
    (
        "1.2",
        "Report Import PPN Masukan (8 kolom)",
        DONE,
        "Report sudah punya persis 8 kolom yang diminta; terblokir bug dispatcher",
        "prd_levis_begbal 27 baris",
        "5a405ab",
    ),
    (
        "1.3",
        "Report Ekualisasi Biaya vs Objek Pemotongan PPh",
        DONE,
        ...
        "0 -> 112 baris. PPN tepat 11% dari DPP per baris",
        "849fadc",
    ),
    ("1.4", "Report Upload Retur Pajak", CLIENT, "Butuh template import Coretax dari klien", "", ""),
    (
        "1.5",
        "Report Upload Faktur Pajak Keluaran",
        CLIENT,
        "Butuh template XLS Mitra Pajakku. Modul yang ada adalah API adapter, bukan penulis template",
        "",
        "",
    ),
    (
        "1.6",
        "Mapping COA jurnal PPh, tetap bisa diubah Accounting",
        DONE,
    ...
    (
        "2",
        "Jurnal PPh input manual tidak muncul di Rekap PPh",
        DONE,
        ...
        "50 -> 105 baris; total 532.229.118,00 tie PERSIS ke GL credit",
        "45b5f78",
    ),
    (
        "3",
        "Report Import PPN Masukan keluar Trial Balance",
        DONE,
        "Bug dispatcher yang sama dengan EO #5",
        "prd_levis_begbal 27 baris",
        "5a405ab",
    ),
    (
        "4",
        "Belum ada GL Open Items / Outstanding balance",
        DONE,
        "Report baru, residual dihitung AS-OF per tanggal (bukan residual saat ini)",
        "3.827 baris, 18.397.721.518,82 = saldo GL akun rekonsiliasi (selisih 0,00)",
        "5465932",
    ),
    (
        "5",
        "Report mapping vendor bill vs payment number",
        DONE,
        ...
        "= jumlah residual bill (selisih 0,00)",
        "5465932",
    ),
    (
        "6",
        "On Hand Inventory report belum ada",
        DONE,
        "Modul terinstall. CATATAN: akan tampil kosong sampai penerimaan barang dicatat di Odoo",
        "prd_levis_begbal: 0 stock_quant, 0 purchase order",
        "",
    ),
    (
        "7",
        "Purchase Return report belum ada",
        DONE,
    ...
    (
        ...
        "Purchase report keluar Trial Balance",
        DONE,
        "Bug dispatcher yang sama",
        "prd_levis_begbal 69 baris",
        "5a405ab",
    ),
    (
        "9",
        "Sales report belum menampilkan data apapun",
        DONE,
        ...
        "0 -> 11.496 baris (Juni 2026); Sales Net 5.633.504.522,00 = revenue GL",
        "ef10d55",
    ),
    (
        "10",
        "Sales report detail layout X24DN (COGS & margin)",
        DONE,
        ...
        "Diskon 1.234.678.813 = jumlah ri_src_discount",
        "ef10d55",
    ),
    (
        "11",
        "Keterangan jurnal PPh & PPN hilang saat reset to draft",
        DONE,
        ...
        "2.702.702,70 dengan jurnal baru (sebelumnya tetap basi)",
        "45b5f78",
    ),
    (
        "12",
        "Modul Petty Cash all store",
        DONE,
        "SUDAH TER-DEPLOY sejak awal. Perlu config per-store + training",
        "custom_petty_cash 19.0.0.4.0 terinstall; 0 record",
        "",
    ),
    ("13", "Report payment bill", DONE, "Dikerjakan bersama item #5 (permintaan identik)", "Lihat item #5", "5465932"),
]
...
cell = wb.add_format({"font_size": 10, "border": 1, "border_color": C_RULE, "valign": "top", "text_wrap": True})
cell_c = wb.add_format({"font_size": 10, "border": 1, "border_color": C_RULE, "valign": "top", "align": "center"})
mono = wb.add_format(
    {"font_size": 9, "font_name": "Consolas", "border": 1, "border_color": C_RULE, "valign": "top", "text_wrap": True}
)
STATUS_FMT = {
    DONE: wb.add_format(
        {
...
big_lbl = wb.add_format(
    {"font_size": 10, "align": "center", "valign": "vcenter", "border": 1, "border_color": C_RULE, "text_wrap": True}
)
...
r = 5
ws.write(r, 0, "Status", hdr)
ws.write(r, 1, "Jumlah", hdr)
ws.write(r, 2, "Arti", hdr)
meaning = {
...
r += 1
ws.write(r, 0, "Catatan penting", hdr)
ws.write(r, 1, "", hdr)
ws.write(r, 2, "", hdr)
r += 1
notes = [
...
ws2.write(3, 0, "Item", hdr)
ws2.write(3, 1, "Yang dibutuhkan", hdr)
ws2.set_column(0, 0, 18)
ws2.set_column(1, 1, 104)
for i, (a, b) in enumerate(WAITING, start=4):
    ws2.write(i, 0, a, cell)
    ws2.write(i, 1, b, cell)
...
r = 4 + len(DEPLOY) + 1
ws3.write(r, 0, "Backup", hdr)
ws3.write(r, 3, "", hdr)
ws3.write(r + 1, 0, "pg_dump", cell)
ws3.write(
    r + 1,
    3,
    "Diambil sebelum setiap rollout; ukuran dan integritas gzip diverifikasi. Tersimpan di /opt/odoo-platform/backups/",
    cell,
)
    ...
    for no, item, status, ket, bukti, commit in rows:
        out.append(
            ...
            % (
                ...
                html.escape(ket),
                html.escape(bukti),
                ("<code>%s</code>" % html.escape(commit)) if commit else "",
            )
        )
...
def build_html():
    ...
    waiting = "".join(
        "<tr><td class='no'>%s</td><td>%s</td></tr>" % (html.escape(a), html.escape(b)) for a, b in WAITING
    )
    deploy = "".join(
        "<tr><td><code>%s</code></td><td class='no'>%s</td><td class='no'>%s</td>"
        "<td class='ev'>%s</td></tr>" % (html.escape(m), html.escape(v), html.escape(n), html.escape(k))
