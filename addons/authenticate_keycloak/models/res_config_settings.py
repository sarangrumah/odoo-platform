...
class ResConfigSettings(models.TransientModel):
    ...
    auth_keycloak_button_label = fields.Char(
        string="Button Name", default="Login with Keycloak", config_parameter="authenticate_keycloak.button_label"
    )
    auth_keycloak_is_active = fields.Boolean(
        string="Activate Keycloak Login", config_parameter="authenticate_keycloak.is_active"
    )
    auth_keycloak_css_class = fields.Char(
        string="CSS class",
        default="fa fa-fw fa-sign-in text-primary",
        config_parameter="authenticate_keycloak.css_class",
    )
    auth_keycloak_client_id = fields.Char(
        string="Client ID",
        readonly=True,
    ...
    auth_keycloak_base_url = fields.Char(
        string="Base URL",
        readonly=True,
