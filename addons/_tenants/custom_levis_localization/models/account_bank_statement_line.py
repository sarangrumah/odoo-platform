...
class AccountBankStatementLine(models.Model):
    ...
    levis_ou_analytic_id = fields.Many2one(
        ...
        # Not "Operating Unit": account.move already contributes a field by that
        # label through _inherits, and it means something else — the OU of the
        # journal entry, not the shop this narrative resolves to.
        string="Settlement Store",
        compute="_compute_levis_narrative",
        store=True,
        readonly=True,
