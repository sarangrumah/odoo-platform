...
class ResConfigSettings(models.TransientModel):
    ...
    custom_super_admin_orchestrator_url = fields.Char(
        ...
        help="Base URL of the tenant-orchestrator service. "
             "Internal Docker DNS name in normal multitenant deploy.",
    )
    custom_super_admin_grafana_base_url = fields.Char(
        ...
        help="Public base URL where Grafana is reachable for ops dashboards "
             "(e.g. https://grafana.platform.localhost).",
    )
