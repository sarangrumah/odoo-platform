...
class MrpEco(models.Model):
    ...
    proposed_bom_id = fields.Many2one("mrp.bom",
                                       help="New revision; will be promoted on final approval.")
    ...
    stage_id = fields.Many2one("mrp.eco.stage", index=True, tracking=True,
    ...
    def action_submit(self):
        for rec in self:
            ...
            first_stage = self.env["mrp.eco.stage"].sudo().search(
    ...
    def action_approve(self):
        for rec in self:
            ...
            next_stage = self.env["mrp.eco.stage"].sudo().search(
            ...
            if next_stage and not rec.stage_id.is_final:
                ...
                rec._pdp_audit_write("eco_stage_advance", rec.id,
    ...
    def _promote_revision(self):
        ...
        self._pdp_audit_write("eco_approved", self.id,
