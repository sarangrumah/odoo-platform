...
class MaintenanceHealthWizard(models.TransientModel):
    _name = "custom.report.maintenance.health.wizard"
    _inherit = "custom.report.wizard.mixin"
    _description = "Maintenance Health Report Wizard"
    ...
    def action_export_xlsx(self):
        ...
        filename = "Maintenance_Report_%s_%s.xlsx" % (self.date_from, self.date_to)
        return self.env["custom.report.maintenance.health"]._xlsx_action(options, filename)
