# -*- coding: utf-8 -*-
"""Sales register over posted customer invoices.

One row per invoice product line (out_invoice / out_refund, refunds
signed negative), with an optional grouping (customer / product / month)
that adds subtotal rows. The native Sales Analysis pivot is left as-is;
this is the single curated template requested for the report menu.
