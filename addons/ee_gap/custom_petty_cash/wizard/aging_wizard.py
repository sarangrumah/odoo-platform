...
class PettyCashAgingWizard(models.TransientModel):
    _name = "petty.cash.aging.wizard"
    _inherit = "custom.report.wizard.mixin"
    _description = "Petty Cash Aging Wizard"
    ...
    def action_export_xlsx(self):
        ...
        filename = "Petty_Cash_Aging_%s.xlsx" % self.date_to
        return self.env["petty.cash.report.aging"]._xlsx_action(options, filename)
