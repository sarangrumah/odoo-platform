...
_CATEGORY_SYNONYMS = {
    "atasan": "tops", "baju": "tops", "kaos": "tops", "kemeja": "tops", "blus": "tops",
    "blouse": "tops", "shirt": "tops", "tee": "tops", "top": "tops",
    "dress": "dresses", "gaun": "dresses", "terusan": "dresses", "gown": "dresses",
    "rok": "skirts", "skirt": "skirts",
    "celana": "trousers", "celana panjang": "trousers", "pants": "trousers", "trouser": "trousers",
    "celana pendek": "shorts", "hotpants": "shorts", "short": "shorts",
    "jumpsuit": "jumpsuits",
    "setelan": "sets", "set": "sets",
    "tas": "bags", "tote": "tote", "selempang": "crossbody",
    "sepatu": "shoes",
    "aksesori": "accessories", "aksesoris": "accessories",
    "jaket": "outerwear", "luaran": "outerwear", "outer": "outerwear", "mantel": "outerwear",
    "rajut": "knitwear", "sweater": "knitwear", "cardigan": "knitwear",
    "syal": "scarves", "selendang": "scarves", "scarf": "scarves",
    "topi": "hats",
    "perhiasan": "jewelry", "kalung": "jewelry", "anting": "jewelry", "gelang": "jewelry",
}
