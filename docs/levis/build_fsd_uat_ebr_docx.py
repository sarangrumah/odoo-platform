...
Usage:  python docs/levis/build_fsd_uat_ebr_docx.py
Output: docs/levis/FSD - ERA Busana Retailindo (Levi's) v1.0.docx
        docs/levis/UAT Detail - ERA Busana Retailindo (Levi's) v1.0.docx
...
class Builder:
    ...
    def approval(self, intro, rows):
        ...
        self.p(intro)
        self.table(["Peran", "Nama", "Jabatan / Fungsi", "Tanda Tangan", "Tanggal"],
                   rows, widths=[4.4, 3.2, 4.6, 2.5, 2.0])
        self.h("Riwayat Revisi", 2)
        self.table(["Versi", "Tanggal", "Penyusun", "Deskripsi Perubahan"], [
...
SUBTITLE = ("PT Sinar Eka Selaras (SES — SAP)  ×  PT Era Busana Retailindo (EBR — Odoo)"
            "  ×  POS Principal Levi's")
...
def build_fsd():
    ...
    b.p("Erajaya Group melalui PT Sinar Eka Selaras (SES) bertindak sebagai distributor resmi "
    ...
    b.p("Dokumen ini mendefinisikan kebutuhan fungsional implementasi Odoo untuk PT Era Busana "
    ...
    b.p("Rantai proses melibatkan empat aktor dengan tiga sistem berbeda. Levi's Principal "
    ...
    b.table(["Langkah", "Aktivitas", "Sistem"], [
    ...
    b.p("Kebutuhan fungsional berikut menjadi dasar konfigurasi, pengembangan, dan penyusunan "
        ...
        "dokumen UAT.")
    b.table(["ID", "Kebutuhan Fungsional", "Deskripsi", "Prioritas"], [
        ["FR-01", "Purchase Order EBR → SES",
         "Pengguna EBR membuat, mengubah, dan mengonfirmasi PO kepada SES dengan approval "
         "berjenjang sesuai matriks otorisasi (custom_approval_engine).", "M"],
        ["FR-02", "Mirror GR toko ke Odoo",
         "GR di POS principal direplikasi ke Odoo sebagai receipt atas PO EBR, menambah stok "
         "warehouse toko dan menjadi dasar pencocokan vendor bill.", "M"],
        ["FR-03", "Vendor bill & pembayaran SES",
         "Vendor bill SES dicatat dan dicocokkan terhadap PO dan GR (three-way match) sebelum "
         "pembayaran diproses.", "M"],
        ["FR-04", "Mirror penjualan POS (X24DN)",
         ...
         "Phase 5; executor menahan posting hingga diaktifkan.", "P2"],
        ["FR-05", "Mirror tender & settlement (X70D/X70T)",
         "Rincian metode pembayaran dan settlement diimpor sebagai payment register untuk "
         "rekonsiliasi terhadap penerimaan bank per acquirer.", "P2"],
        ["FR-06", "Mirror mutasi & on-hand (X32P/X20)",
         "Mutasi persediaan bernilai direplikasi sebagai stock move; X20 untuk saldo awal "
         "(one-shot) dan validasi stok periodik.", "M"],
        ["FR-07", "Import master data",
         "Master produk X101 (artikel, varian size/inseam, barcode, kategori, harga), CoA, "
         "company detail, dan store master diimpor melalui profil import.", "M"],
        ["FR-08", "Wizard import dengan dry-run",
         "Setiap unggah menampilkan pratinjau hasil parsing sebelum commit; file besar diproses "
         "asinkron via queue_job.", "M"],
        ["FR-09", "Deduplikasi & idempotensi",
         "File identik (SHA256) ditolak saat diimpor ulang; re-import record menghasilkan update "
         "via external ID, bukan duplikasi.", "M"],
        ["FR-10", "Log audit import",
         "Setiap import tercatat (pengguna, waktu, jumlah baris, error) dan file sumber "
         "diarsipkan sebagai attachment untuk audit.", "M"],
        ["FR-11", "SFTP feed otomatis",
         "Odoo polling terjadwal ke FTP/SFTP Erajaya per jenis file, memproses file baru melalui "
         "executor yang sama dengan unggah manual, dan memberi notifikasi bila parsing gagal.", "P2"],
        ["FR-12", "Klaim promosi (X31)",
         "Data diskon/promo diimpor sebagai dasar klaim promosi kepada principal/SES.", "P2"],
        ["FR-13", "Pelaporan keuangan",
         "Laporan keuangan lengkap (Excel/PDF) via custom_accounting_full; dokumen transaksi "
         "(Invoice, Quotation, PO) ber-branding via custom_report_templates.", "M"],
        ["FR-14", "Pajak Indonesia",
         "PPN keluaran/masukan dikonfigurasi sesuai tarif; integrasi Coretax/e-Faktur dan bukti "
         "potong via custom_coretax dan custom_coretax_bupot.", "M"],
    ], widths=[1.6, 4.0, 8.6, 2.0])
    b.doc.add_page_break()

    # ---- 4. Modul ----
    b.h("4. Modul Odoo yang Diinstal dan Kustomisasi", 1)
    b.p("Tenant EBR diprovision menggunakan Industry Pack \"Retail / POS\" pada platform Odoo "
    ...
    b.table(["Modul", "Fungsi pada Implementasi Ini"], [
    ...
    b.p("Adapter mirroring Excel/CSV → Odoo dan SFTP feed; komponen inti integrasi Flow C, "
    ...
    b.table(["Report / File", "Isi Data", "Tujuan di Odoo", "Frekuensi"], [
        ["X101_Material_Master", "Master produk Levi's (artikel, SKU, barcode, harga).",
         "Product master (create/update produk).", "Saat ada perubahan"],
        ["X20_Current_Onhand_Inventory", "Posisi stok on-hand per toko.",
         "Saldo awal (one-shot) dan validasi stok.", "Harian / periodik"],
        ["X24DN_Retail_Sales_Detail", "Detail transaksi penjualan POS per toko.",
         "Penjualan (jurnal penjualan + HPP).", "Harian (EOD)"],
        ["X70D / X70T (Tender)", "Metode pembayaran dan settlement.",
         "Payment register & rekonsiliasi bank.", "Harian (EOD)"],
        ["X32P_Stock_Movement", "Mutasi persediaan bernilai (GR, transfer, retur, adjustment).",
         "Stock move dan receipt.", "Harian / periodik"],
        ["X31_Discount_Journal", "Data diskon/promo.", "Dasar klaim promosi.", "Bulanan / per program"],
        ["Store Master", "Daftar 24 lokasi (1 DC + 23 toko).",
         "Warehouse per toko + crosswalk kode toko.", "Saat ada perubahan"],
    ...
    b.p("Penyiapan data tenant EBR mengikuti urutan: konfigurasi dasar (company, CoA, bank, "
    ...
    b.table(["No", "Data", "Sumber", "Cara Load"], [
        ["1", "Company Detail (EBR)", "Sheet legal entity (key/value).",
    ...
    b.p("Tim ops mengekspor report principal lalu mengunggahnya ke Odoo melalui wizard import "
    ...
    b.p("File report di-drop otomatis ke server FTP/SFTP Erajaya sesuai jadwal. Odoo polling "
    ...
    b.table(["No", "Isu", "Dampak", "Tindak Lanjut"], [
        ["1", "File X20/X24/X70D masih sampel satu toko (store 14694 — Tunjungan Plaza 3).",
         "Saldo awal & penjualan hanya untuk satu toko.",
         "Minta ekstrak lengkap seluruh toko atau aktifkan feed SFTP."],
        ["2", "Store Master tanpa kode toko untuk 23 dari 24 lokasi.",
         "Crosswalk kode toko → warehouse tidak lengkap.",
         "Minta store master lengkap dengan kode SAP; loader idempoten."],
        ["3", "Keputusan Phase 5 (representasi POS, histori, tax mapping) belum ditetapkan.",
    ...
    b.p("Dengan disetujuinya dokumen ini, tim implementasi melanjutkan ke konfigurasi, migrasi "
...
def build_uat():
    b = Builder()
    b.cover("USER ACCEPTANCE TESTING", "(UAT Detail)",
            "UAT Detail — Implementasi Odoo Bisnis Retail Levi's PT Era Busana Retailindo",
            SUBTITLE, "UAT/ERAJAYA/EBR-LEVIS/2026/005",
    ...
    b.h("1. Pendahuluan", 1)
    b.h("1.1 Tujuan", 2)
    b.p("Dokumen ini mendefinisikan pendekatan, kriteria, dan skenario rinci User Acceptance "
    ...
    b.bullets([
        ...
        "Kontrol adapter import: dry-run preview, deduplikasi, force re-import, audit log, "
        "eksekusi asinkron.",
        "Procurement EBR → SES: PO, approval berjenjang, GR mirror, vendor bill three-way "
        "match, dan pembayaran.",
    ...
    b.p("UAT dijalankan pada database tenant Odoo terpisah (mis. levis_uat) yang merupakan "
    ...
    b.h("2.2 Data Uji", 2)
    b.table(["Data Uji", "Sumber", "Catatan"], [
    ...
    b.table(["Peran", "Pihak", "Tanggung Jawab pada UAT"], [
    ...
    b.table(["Severity", "Definisi", "Target Penyelesaian"], [
        ["Critical", "Fungsi inti gagal/blok go-live; tidak ada workaround (mis. import master gagal total, posting jurnal salah).", "Sebelum lanjut UAT"],
        ["High", "Fungsi penting salah hasil; workaround sulit (mis. dedup tidak jalan, three-way match keliru).", "≤ 2 hari kerja"],
    ...
    b.p("Setiap test case dieksekusi dan diberi status Lulus, Gagal, atau Blocked. Test case "
    ...
    b.table(["Prefix Suite", "Area", "FR Terkait"], [
    ...
    b.p("Setiap kebutuhan fungsional FSD dipetakan ke satu atau lebih test case UAT untuk "
        "memastikan cakupan penuh.")
    b.table(["FR", "Kebutuhan Fungsional", "Test Case UAT"], [
    ...
    b.p("Setiap test case berikut disiapkan untuk dieksekusi dan dicatat hasilnya. Kolom Hasil "
        "Aktual, Status, Penguji/Tanggal, dan Catatan diisi saat eksekusi UAT.", italic=True)
    ...
    b.p("Seluruh test case berstatus Gagal/Blocked dicatat pada tabel berikut dan ditindaklanjuti "
        "sesuai alur defect (Bab 2.7).")
    b.table(["No", "Test Case", "Deskripsi Defect", "Severity", "Status", "PIC", "Tgl Selesai"], [
        ["", "", "", "", "", "", ""],
        ["", "", "", "", "", "", ""],
        ["", "", "", "", "", "", ""],
        ["", "", "", "", "", "", ""],
    ...
    b.table(["Suite", "Jml Test Case", "Lulus", "Gagal", "Blocked", "% Lulus"], [
    ...
    b.p("Tandai salah satu keputusan berikut berdasarkan hasil eksekusi dan kriteria keluar "
        "(Bab 2.5):")
    b.bullets([
        ...
        "Ditolak (Rejected) — terdapat defect Critical/High terbuka; UAT diulang setelah "
        "perbaikan.",
    ])
    b.h("9.3 Lembar Tanda Tangan Hasil UAT", 2)
    b.table(["Peran", "Nama", "Keputusan", "Tanda Tangan", "Tanggal"], [
        ["UAT Lead — Erajaya", "", "", "", ""],
...
SUITES = [
    ("4.1 Suite UAT-ENV — Lingkungan dan Smoke Test", [
        {
            "id": "UAT-ENV-01", "title": "Verifikasi modul & menu Retail Import terpasang",
            "fr": "Prasyarat seluruh FR", "prio": "Tinggi",
        ...
        {
            "id": "UAT-ENV-02", "title": "Verifikasi 6 profil import Levi's ter-seed",
            "fr": "FR-07, FR-08", "prio": "Tinggi",
    ...
    ("4.2 Suite UAT-MD — Import Master Data", [
        {
            "id": "UAT-MD-01", "title": "Import Company / Legal Entity (levis_company)",
            "fr": "FR-07", "prio": "Tinggi",
        ...
        {
            "id": "UAT-MD-02", "title": "Import Chart of Accounts (levis_coa)",
            "fr": "FR-07", "prio": "Tinggi",
        ...
        {
            "id": "UAT-MD-03", "title": "Dry-run preview sebelum commit (X101)",
            "fr": "FR-08", "prio": "Tinggi",
        ...
        {
            "id": "UAT-MD-04", "title": "Import master produk X101 (asinkron via queue_job)",
            "fr": "FR-07, FR-08", "prio": "Tinggi",
            ...
            "expected": [
                ...
                "product.template ±14.885; product.product ±159.658 dengan default_code=SKU dan "
                "barcode=GTIN.",
        ...
        {
            "id": "UAT-MD-05", "title": "Perbaikan encoding U+FFFD → ® pada deskripsi produk",
            "fr": "FR-07", "prio": "Sedang",
        ...
        {
            "id": "UAT-MD-06", "title": "Idempotensi re-import X101 (external ID, tanpa duplikasi)",
            "fr": "FR-09", "prio": "Tinggi",
        ...
        {
            "id": "UAT-MD-07", "title": "Pembentukan warehouse dari Store Master",
            "fr": "FR-07", "prio": "Tinggi",
            ...
            "expected": [
                "Warehouse terbentuk per toko (target 24); external ID wh_<storecode> menjadi "
                "kunci join file X.",
    ...
    ("4.3 Suite UAT-IMP — Kontrol Adapter Import", [
        {
            "id": "UAT-IMP-01", "title": "Deduplikasi file identik (SHA256) ditolak",
            "fr": "FR-09", "prio": "Tinggi",
        ...
        {
            "id": "UAT-IMP-02", "title": "Force re-import menimpa penolakan dedup",
            "fr": "FR-09", "prio": "Sedang",
        ...
        {
            "id": "UAT-IMP-03", "title": "File gagal tidak memblokir unggah ulang",
            "fr": "FR-09", "prio": "Sedang",
        ...
        {
            "id": "UAT-IMP-04", "title": "Kelengkapan log audit & arsip file sumber",
            "fr": "FR-10", "prio": "Tinggi",
        ...
        {
            "id": "UAT-IMP-05", "title": "Import partial — pelaporan error per baris",
            "fr": "FR-10", "prio": "Sedang",
        ...
        {
            "id": "UAT-IMP-06", "title": "Dispatch asinkron vs sinkron sesuai jenis file",
            "fr": "FR-08", "prio": "Sedang",
            ...
            "expected": [
                "Jenis file besar (x101, x20, x24, x70d, x32p) diproses asinkron via queue_job "
                "(job_uuid terisi).",
    ...
    ("4.4 Suite UAT-OS — Saldo Awal Stok (X20)", [
        {
            "id": "UAT-OS-01", "title": "Import saldo awal on-hand (X20) ke stock.quant",
            "fr": "FR-06", "prio": "Tinggi",
        ...
        {
            "id": "UAT-OS-02", "title": "Guard one-shot saldo awal menolak re-run",
            "fr": "FR-06", "prio": "Tinggi",
            ...
            "data": "File X20 (ulang).",
            "expected": [
                "Sistem menolak eksekusi ulang (guard one-shot via penanda; mencegah penggandaan "
                "on-hand).",
                "On-hand tidak berubah/berlipat.",
            ],
        },
        {
            "id": "UAT-OS-03", "title": "Resolusi varian & lokasi pada X20",
            "fr": "FR-06", "prio": "Sedang",
    ...
    ("4.5 Suite UAT-PR — Procurement EBR → SES", [
        {
            "id": "UAT-PR-01", "title": "Buat Purchase Order EBR ke vendor PT SES",
            "fr": "FR-01", "prio": "Tinggi",
        ...
        {
            "id": "UAT-PR-02", "title": "Approval berjenjang PO via approval engine",
            "fr": "FR-01", "prio": "Tinggi",
        ...
        {
            "id": "UAT-PR-03", "title": "Mirror GR toko memvalidasi receipt atas PO",
            "fr": "FR-02", "prio": "Tinggi",
            ...
            "expected": [
                "Receipt atas PO EBR tervalidasi; stok warehouse toko bertambah sesuai qty "
                "diterima.",
                "Selisih qty (kurang/lebih) terlihat untuk ditindaklanjuti sebagai discrepancy.",
            ],
        },
        {
            "id": "UAT-PR-04", "title": "Vendor bill three-way match (PO–GR–Bill)",
            "fr": "FR-03", "prio": "Tinggi",
        ...
        {
            "id": "UAT-PR-05", "title": "Pembayaran kepada SES dan pelunasan AP",
            "fr": "FR-03", "prio": "Tinggi",
    ...
    ("4.6 Suite UAT-MR — Mirroring Operasional (Flow C)", [
        {
            "id": "UAT-MR-01", "title": "Gating Phase 5 — import penjualan X24 menahan posting",
            "fr": "FR-04", "prio": "Tinggi",
        ...
        {
            "id": "UAT-MR-02", "title": "Gating Phase 5 — import tender X70D menahan posting",
            "fr": "FR-05", "prio": "Tinggi",
        ...
        {
            "id": "UAT-MR-03", "title": "Staged — mutasi persediaan X32P di-parse & dihitung",
            "fr": "FR-06", "prio": "Sedang",
        ...
        {
            "id": "UAT-MR-04", "title": "Staged — klaim promosi X31 di-parse & dihitung",
            "fr": "FR-12", "prio": "Rendah",
        ...
        {
            "id": "UAT-MR-05", "title": "(Pasca Phase 5) Posting penjualan X24 → pos.order + jurnal",
            "fr": "FR-04", "prio": "Tinggi",
        ...
        {
            "id": "UAT-MR-06", "title": "(Pasca Phase 5) Tender X70D → pos.payment ter-join ke X24",
            "fr": "FR-05", "prio": "Tinggi",
            "pre": "UAT-MR-05 aktif; X70D & X24 untuk periode yang sama tersedia.",
            "steps": [
                "1. Import X70D pasca Phase 5.",
                "2. Verifikasi pos.payment ter-join ke order X24 via kunci (store, date, register, "
                "transnum).",
            ],
    ...
    ("4.7 Suite UAT-FT — SFTP Feed (Phase 2)", [
        {
            "id": "UAT-FT-01", "title": "Test Connection feed SFTP",
            "fr": "FR-11", "prio": "Tinggi",
        ...
        {
            "id": "UAT-FT-02", "title": "Poll Now menarik & memproses file baru",
            "fr": "FR-11", "prio": "Tinggi",
        ...
        {
            "id": "UAT-FT-03", "title": "Dedup skip pada polling berulang",
            "fr": "FR-11, FR-09", "prio": "Sedang",
        ...
        {
            "id": "UAT-FT-04", "title": "Cron poller terjadwal",
            "fr": "FR-11", "prio": "Sedang",
            "pre": "Feed aktif; cron \"Retail Import: poll SFTP feeds\" diaktifkan.",
            "steps": [
                "1. Settings ▸ Technical ▸ Scheduled Actions; aktifkan cron poll feeds (default "
                "nonaktif).",
        ...
        {
            "id": "UAT-FT-05", "title": "Penanganan error koneksi feed",
            "fr": "FR-11", "prio": "Sedang",
    ...
    ("4.8 Suite UAT-RP — Pelaporan dan Rekonsiliasi", [
        {
            "id": "UAT-RP-01", "title": "Laporan keuangan lengkap (Excel/PDF)",
            "fr": "FR-13", "prio": "Tinggi",
            "pre": "Modul custom_accounting_full terpasang; ada transaksi (PO/Bill/Payment).",
            "steps": [
                "1. Accounting ▸ Reporting; jalankan General Ledger, Trial Balance, P&L, Balance "
                "Sheet.",
        ...
        {
            "id": "UAT-RP-02", "title": "Template PDF transaksi ber-branding per company",
            "fr": "FR-13", "prio": "Sedang",
        ...
        {
            "id": "UAT-RP-03", "title": "Rekonsiliasi settlement tender (X70T) vs bank",
            "fr": "FR-05", "prio": "Sedang",
        ...
        {
            "id": "UAT-RP-04", "title": "Valuasi persediaan mencerminkan saldo awal & mutasi",
            "fr": "FR-13, FR-06", "prio": "Sedang",
    ...
    ("4.9 Suite UAT-TX — Pajak (PPN / Coretax)", [
        {
            "id": "UAT-TX-01", "title": "Konfigurasi & penerapan PPN pada PO/Bill",
            "fr": "FR-14", "prio": "Tinggi",
        ...
        {
            "id": "UAT-TX-02", "title": "Ekspor e-Faktur / Coretax",
            "fr": "FR-14", "prio": "Sedang",
        ...
        {
            "id": "UAT-TX-03", "title": "Bukti potong (custom_coretax_bupot)",
            "fr": "FR-14", "prio": "Rendah",
    ...
    ("4.10 Suite UAT-SEC — Keamanan dan Hak Akses", [
        {
            "id": "UAT-SEC-01", "title": "Hak akses Retail Import User",
            "fr": "FR-08, FR-10", "prio": "Tinggi",
        ...
        {
            "id": "UAT-SEC-02", "title": "Hak akses Retail Import Manager",
            "fr": "FR-08, FR-10", "prio": "Sedang",
            "pre": "Akun dengan grup \"Retail Import / Manager\".",
            "steps": [
                "1. Login sebagai Manager.",
                "2. Akses Configuration ▸ Import Profiles & SFTP Feeds; ubah profil; lakukan "
                "Force re-import.",
            ],
        ...
        {
            "id": "UAT-SEC-03", "title": "Penyimpanan kredensial SFTP terbatas",
            "fr": "FR-11", "prio": "Sedang",
